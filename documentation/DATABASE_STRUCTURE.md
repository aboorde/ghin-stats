...
| golfer_id            | bigint                   | number  | Links to existing scores.golfer_id for data ownership                                                 |
| ghin_number          | text                     | string  | Official GHIN number for handicap verification                                                        |
| home_course_name     | text                     | string  |                                                                                                       |
| subscription_tier    | text                     | string  | User subscription level: free, premium, or pro                                                        |
| subscription_status  | text                     | string  |                                                                                                       |
| profile_visibility   | text                     | string  | Controls whether profile is visible to other users                                                    |
| display_handicap     | boolean                  | boolean | Whether to show handicap on public profile                                                            |
| display_scores       | boolean                  | boolean | Whether to show scores on public profile                                                              |
| preferred_tees       | text                     | string  |                                                                                                       |
| measurement_system   | text                     | string  |                                                                                                       |
| onboarding_completed | boolean                  | boolean |                                                                                                       |
| last_login_at        | timestamp with time zone | string  |                                                                                                       |
| created_at           | timestamp with time zone | string  |                                                                                                       |
| updated_at           | timestamp with time zone | string  |                                                                                                       |
| handicap_index       | numeric                  | number  |                                                                                                       |
| display_statistics   | boolean                  | boolean | Controls whether user statistics (course summaries, yearly analysis, etc.) are visible to other users |
